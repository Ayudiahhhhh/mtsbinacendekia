                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <div class="footer-btn text-start">
                                <a href="moment.php" class="btn btn-dark rounded-pill px-4">View All Post <i class="fa fa-arrow-right ms-1"></i></a>
                            </div>
                                <div class="position-relative mx-auto rounded-pill">
                                <!--
                                    <input class="form-control rounded-pill w-100 py-3 ps-4 pe-5" type="text" placeholder="Enter your email">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a class="btn btn-md-square me-2"href="whatsapp://send?text=Hello&phone=+6285797235593"><img src="<?= ASSETS_PATH ?>/wa.jpeg" width="40" height="40" style="border:50%;"></a>
                            <a class="btn btn-md-square me-2" href="https://www.instagram.com/mtsbinacendekia/"><img src="<?= ASSETS_PATH ?>/instagram.jpeg" width="40" height="40" style="border:50%;"></a>
                            <a class="btn btn-md-square me-2"href="https://youtube.com/@mtsbinacendekiacirebon6066?si=d3WriuQU8C4peHrT"><img src="<?= ASSETS_PATH ?>/youtube.jpeg" width="40" height="40" style="border:50%;"></a>
                            <a class="btn btn-md-square me-2" href="https://www.facebook.com/MTsBinaCendekiaCirebon"><img src="<?= ASSETS_PATH ?>/facebook.jpeg" width="40" height="40" style="border:50%;"></a>
                            <!--
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-primary"><i class="fas fa-copyright text-light me-2"></i>Mts Bina Cendekia</a></span>
                    </div>
                    <div class="col-md-6 text-center text-md-end text-body">
                        <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->
                        <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->
                        <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->
                        Designed By <a class="border-bottom text-primary" href="team.php"> The Kids m.m</a>
                    </div>
                </div>
            </div>
        </div>
